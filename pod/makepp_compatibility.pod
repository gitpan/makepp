...
=for vc $Id: makepp_compatibility.pod,v 1.35 2012/02/28 21:41:30 pfeiffer Exp $
...
<li>Click the navigation bar's close button (&#xd7;) to have more space for the table!</li>
</ul>
...
badly.  If it recognized that it's running on a 64 bit Perl, it will rewrite
