...
=for vc $Id: makepp_statements.pod,v 1.42 2011/10/30 20:57:44 pfeiffer Exp $
...
The keyword C<global> may precede this statement with the same effect as the
command line option, i.e. the signature method applies in every makefile which
does not specify its own.  This should best be given in a F<RootMakeppfile> to
