...
=for vc $Id: makepp_statements.pod,v 1.30 2007/05/06 10:06:29 pfeiffer Exp $

=head1 DESCRIPTION

L<B<a>nd|/Conditionals>,E<nbsp>
...
L<B<i>fdef|/ifdef>, L</ifeq>, L</ifmakeperl>, L<ifndef|/ifdef>, L<ifneq|/ifeq>,
  L<ifnsys|/ifsys>, L</ifperl>, L</ifsys>, L</include>, L</_include>,E<nbsp>
L<B<l>oad_makefile|/load_makefile>,E<nbsp>
L<B<m>ake|/prebuild>, L<perl|/makeperl>, L</makesub>,E<nbsp>
...
C<ifeq> and its friends C<ifneq>, C<ifdef>, C<ifndef>, C<ifperl> and
C<ifmakeperl> are primarily useful when you have to build a program under
several different conditions.  For example,
...
=item register_scanner command_word scanner_subroutine_name

Registers the C<scanner_subroutine_name> subroutine (which usually begins with
...
exact type CommandParser::C<class_name> as the command parser
...
of a command by the C<CommandParser> base class, its runtime dependencies
...
it uses a special C<CommandParser> class that overrides this behavior).
