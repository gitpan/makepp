...
=for vc $Id: makepp_functions.pod,v 1.42 2011/05/07 11:08:30 pfeiffer Exp $
...
directory location.  If I<slash> is true (usually C<1>) the returned filenames
are guaranteed to contain a slash by prepending C<./> if necessary.
