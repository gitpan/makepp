...
=for vc $Id: makepp_speedup.pod,v 1.9 2006/05/14 16:03:24 pfeiffer Exp $
...
few percent of makepp's CPU time.  Once you have done a full build in an empty
directory with the C<--repository> option, without any adverse side effects,
you can be fairly sure that your rule set is consistent.  Then this option
shouldn't hurt.
