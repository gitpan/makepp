...
=for vc $Id: makepp_builtins.pod,v 1.53 2013/05/19 11:04:58 pfeiffer Exp $
...
replaces all occurrences of C<@macro@>, C<@macro(arg1,arg2...)@> or everything
...
Use I<prefix> and I<suffix> before and after I<var> respectively instead of
C<@>.  The first character is the separator and need not be a slash.

=item -m I</prefix/suffix/afterprefix/[aftersuffix/]>

=item --multiline=I</prefix/suffix/afterprefix/[aftersuffix/]>

Use I<prefix>, I<suffix> and I<afterprefix> before and after I<var> and at the
end of the block respectively instead of C<@@>.  If I<aftersuffix> is also
given, the I<var> name must get repeated before it.  The first character is
the separator and need not be a slash.  E.g. an XML-ish
