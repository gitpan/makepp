...
replaced by C<&template EMPTY_MACRO=''> during the installation process:
...
Use I<prefix> and I<suffix> before and after I<SPECIAL> respectively instead of
...
Use I<prefix>, I<suffix> and I<afterprefix> before and after I<SPECIAL> and at
the end of the block respectively instead of C<@@>.  If I<aftersuffix> is also
