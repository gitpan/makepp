...
=for vc $Id: makepp_release_notes.pod,v 1.69 2011/09/15 21:08:07 pfeiffer Exp $
...
The keyword C<global> can precede the C<build_cache> statement and the
C<define> statement which now also allows C<export>.  Therefore s_ subs now
get a 4th parameter, a hash reference with the encountered keywords as keys.
