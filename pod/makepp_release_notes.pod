...
=for vc $Id: makepp_release_notes.pod,v 1.65 2011/06/05 20:35:22 pfeiffer Exp $
...
Makefile functions may now get their 1st parameter as a string reference.  In
that case you are responsible for expanding your arguments.  Use the accessor
functions C<&arg> or C<args> described in L<makepp
...
variable) or patch it into your new makepp installation.
