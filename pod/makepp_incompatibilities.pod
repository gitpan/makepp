...
=for vc $Id: makepp_incompatibilities.pod,v 1.27 2011/01/16 16:59:29 pfeiffer Exp $
...
from the reliabilty advantage for your development.
...
If that also fails, the build system needs some tweaking to cooperate with makepp.
...
unsupported and will cause errors.  Use L<repositories|makepp_repositories>
instead.
...
because I kept running into problems with GNU make's rules when I accidently
