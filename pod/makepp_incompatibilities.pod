...
=for vc $Id: makepp_incompatibilities.pod,v 1.32 2012/01/11 21:01:47 pfeiffer Exp $
...
C<vpath> statements are emulated with the L<repositoriy|makepp_repositories>
...
perl scipt by magic number or with C<--traditional-recursive-make> this
