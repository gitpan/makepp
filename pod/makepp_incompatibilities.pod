...
=for vc $Id: makepp_incompatibilities.pod,v 1.16 2007/05/06 10:35:46 pfeiffer Exp $
...
The C<SHELL> variable is currently ignored.  Makepp always uses F</bin/sh>.
...
Three GNU make functions (C<call>, C<eval> and C<value>) are not currently
supported.
