...
=for vc $Id: makepp_command.pod,v 1.36 2008/04/15 21:34:48 pfeiffer Exp $
...
L<-B<c>|/_2dc>,
  L<-C|/_2dc_dirname>,
  L<--case-sensitive-filenames|/_2D_2Dcase_2Dsensitive_2Dfilenames>,E<nbsp>
...
L<-B<n>|/_2Dn>,
  --no-builtin-rules,
  L<--no-case-sensitive-filenames|/_2D_2Dno_2Dcase_2Dsensitive_2Dfilenames>,
...
=item --argsfile=filename X<--argsfile>

Read arguments from the specified file, and interpolate them into the
...
This option is mostly useful on cygwin, if you want to override makepp's
...
=item --no-case-sensitive-filenames

Assume the file system is case insensitive.  Makepp converts all
filenames to lowercase.  Do NOT use this if your file system is not
