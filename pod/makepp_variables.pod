...
=for vc $Id: makepp_variables.pod,v 1.24 2007/05/06 10:05:13 pfeiffer Exp $
...
L<B<M>AKE|/MAKE>, L</MAKECMDGOALS>, L</MAKEINFO>,E<nbsp>
L<B<o>utput|/output>, L</outputs>,E<nbsp>
L<B<P>WD|/PWD>,E<nbsp>
L<B<R>M|/RM>, L</ROOT>,E<nbsp>
L<B<s>orted_dependencies|/sorted_dependencies>, L</sorted_inputs>, L</stem>,E<nbsp>
...
C<global::> package.  In fact any variable, not yet present in the current
...
object is accessible via C<$Makesubs::rule->{MAKEFILE}>:

    sub c_cmd { $current_value = $Makesubs::rule->{MAKEFILE}->expand_variable( 'MAKE_VAR' ) }
